...
import com.android.apin.ali.AuthResult;
import com.android.apin.ali.PayResult;
...
public class AliPayActivity extends Activity {
            ...
            switch (msg.what) {
                case SDK_PAY_FLAG: {
                    ...
                    if (TextUtils.equals(resultStatus, "9000")) {
                        ...
                        module.setCode("1");
                        module.setMsg("支付成功");
                        module.setData(""+payResult.getResult());
                    } else {
    ...
    public void payV2(){
        ...
        final String orderInfo = bundle.getString("signOrder");
        //支付宝沙箱android测试需要调用
